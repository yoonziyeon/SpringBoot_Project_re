...
<div id="bsW_wrap">
 ...
 <form method="post" action="bbs_edit_ok?bbs_no=${b.bbs_no}"
  onsubmit="return write_check();" enctype="multipart/form-data">
  <%-- bbs_edit_ok?bbs_no=번호값이 주소창에 노출되는 get방식으로 전달된다. --%>
 <%--
     자료실 기능을 만들때 필요한 사항)
  ...
  <table id="bsW_t">
   ...
   <tr>
    <th>글내용</th>
    <td>
     <textarea name="bbs_cont" id="bbs_cont"
      rows="8" cols="34">${b.bbs_cont}</textarea>
    </td>   
   </tr>
   <tr>
    <th>파일첨부</th>
    <td>
     <input type="file" name="uploadFile" ><br>${b.bbs_file}
    </td>
   </tr>
  </table>
  <div id="bsW_menu">
